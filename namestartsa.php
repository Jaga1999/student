...
<head>
    ...
    <title>Students Name starts with A</title>
     <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
<div class="container">
        <h1 class="mt-5 mb-4">Students Name Starts with A</h1>
	<?php
	show_starts_a_students();
	?>
    <h1>
...
function show_starts_a_students() {
    ...
    $sql = "SELECT * FROM students WHERE firstname LIKE 'a%' OR firstname LIKE 'A%'";
